...
TASK_REGISTRY: dict[str, TaskSpec] = {
    "locomotion/humanoid_flat": TaskSpec(
        ...
        runner_hint="tasks/locomotion/runners/humanoid_flat_runner.py",
    ),
    "locomotion/quadruped": TaskSpec(
        name="locomotion/quadruped",
        family="locomotion",
        backend="IsaacLab or robot_lab",
        description="Quadruped velocity tracking on generated terrain.",
        runner_hint="tasks/locomotion/runners/quadruped_runner.py",
    ),
    "locomotion/wheel_legged": TaskSpec(
        name="locomotion/wheel_legged",
        family="locomotion",
        backend="IsaacLab or robot_lab",
        description="Wheel-legged velocity tracking on generated terrain.",
        runner_hint="tasks/locomotion/runners/wheel_legged_runner.py",
    ),
